...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'bankappfrontend/build')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgresql://postgres:postgres@localhost:5432/bankappdb',
        conn_max_age=600
    )
}
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'bankappfrontend/build/static')
]
